...
app = FastAPI(title="NTRO Dark Web Intel System", version="2.1.0", lifespan=lifespan)
...
def health_check():
    return {"status": "healthy", "pipeline_state": "Steps 1-8 Operational"}
    ...
    <script>
        async function loadActors() {
            try {
                ...
                document.getElementById('target-list').innerHTML = '<p style="color:#f87171;">Error loading targets.</p>';
            }
        }
